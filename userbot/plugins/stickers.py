...
CUSTOM_STICKER_NAME = (
    str(CUSTOM_STICKER_PACK_NAME)
    if CUSTOM_STICKER_PACK_NAME
    else "My Boss DEVIL Volume Pack One"
)
CUSTOM_ANIME_PACK = (
    str(CUSTOM_ANIMATED_PACK_NAME)
    if CUSTOM_ANIMATED_PACK_NAME
    else "My Boss Animated Pack"
)
