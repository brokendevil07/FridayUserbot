...
USER_BOT_NO_WARN = ("`Hello My Friend ! This is` **🅷 🅴 🅻 🅻**\n"
                    ...
                    f"{CUSTOM_MIDDLE_PMP} \n\n"
                    "बड़े दुख के साथ ये बताना पड़ रहा है पीएम में यूजर की मृत्यु हो चुकी है🥺"
"या तो आप किसी सामान्य समूह में टैग करिए,अन्यथा उनके रिप्लाइ के इंतजार में मृत्यु को प्राप्त हो जाइए"
